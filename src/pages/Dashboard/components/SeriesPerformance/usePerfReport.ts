...
const initialData: ActionStorePerf[] = [] as ActionStorePerf[]

const apiHandler = api.Arteli.Perf.byActionStore
...
export const usePerfReport = ({
  ...
  return useQuery({
    initialData,
    queryKey: ['perf-series-rows', ...apiHandler.getQueryKey(params)],
    refetchOnWindowFocus,
    refetchOnMount,
    staleTime,
    gcTime,
